...
public class C02_DropDownOptions {
    ...
    public void test01() {
       ...
       int actualOpsiyonSayisi = opsiyonlarList.size();

        Assert.assertEquals(expectedOptionSayisi,actualOpsiyonSayisi);

        // dropdown'daki optionların tamamını yazdırın
        opsiyonlarList.stream().forEach(t-> System.out.println(t.getText()));//Lambda ile cozumu
